  ...
  return (
    <div className="relative">
      <Overlay
        ...
        dispatch={() => dispatch({ type: 'cartToggle', payload: false })}
      />
      <div
                ...
                return (
                  <div key={item._id} className="py-4 grid grid-cols-5">
                    ...
                    <div className="pl-4 text-black/50 text-sm col-span-3 space-y-1">
                      ...
                      <p className="text-black/80 font-medium">{item.price}000 VND</p>
                    ...
                    <div className="col-span-1 h-full flex flex-col justify-between items-end">
                      <p className="text-black font-semibold text-lg">
                        {subTotalPrice(item._id, item.price)}000 VND
                      </p>
                      <span
          ...
          {carts?.length === 0 ? (
            ...
            <div className="h-32 border-t border-black/10">
              <div className="p-4 flex items-center justify-between">
                ...
                <span className="text-lg font-semibold">{totalPrice()}000 VND</span>
              </div>
              <div className="px-4">
                {isAuth() ? (
                  <Link
