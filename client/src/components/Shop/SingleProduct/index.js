      ...
      <div className="p-8 lg:p-4 flex md:flex-col space-x-24 xl:space-x-12 md:space-x-0 md:space-y-12 select-none">
        ...
        <div className="w-1/2 md:w-full flex md:flex-col">
          ...
          <div
            ...
            style={{
              backgroundImage: `url(/uploads/products/${product.images[currentImage]})`,
          ...
          >
            ...
            {product.images && product.images.length > 1 && (
              <>
                <span
                  onClick={() =>
                    changeSlide('prevSlide', currentImage, setCurrentImage, product.images)
                  }
                ...
                <span
                  onClick={() =>
                    changeSlide('nextSlide', currentImage, setCurrentImage, product.images)
                  }
        ...
        <div className="w-1/2 md:w-full space-y-10">
          <div className="flex items-start justify-between">
            <div className="flex flex-col space-y-3">
              <h1 className="font-bold text-3xl lg:text-2xl md:text-xl text-black">
                {product.name}
              </h1>
              <p className="text-base font-medium text-gray-600">{product.category.name}</p>
              <p className="text-xl font-semibold text-black">{product.price}000 VND</p>
            </div>
            {product.status && (
              <span
            ...
            <p className="text-justify">
              ...
              {product.description.length > 400 && (
                <span
                  ...
                  className="ml-1 text-black/50 cursor-pointer"
                >
          ...
          <div>
            ...
            {product.quantity !== 0 && (
              <div className="flex items-center">
                <span
                  onClick={() =>
                    updateQuantity('decrease', quantity, setQuantity, product.quantity, setAlert)
                  }
                ...
                <span
                  onClick={() =>
                    updateQuantity('increase', quantity, setQuantity, product.quantity, setAlert)
                  }
                  className="w-8 h-8 rounded-full bg-white text-black border border-black/20 flex items-center justify-center cursor-pointer hover:border-black transition-colors"
                >
                  <BsPlus />
