  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {editdata.success && (
          <div className="py-3 px-2 mx-12 text-sm bg-green-100 text-green-700">
            {editdata.success}
          </div>
        )}
        {editdata.error && (
          <div className="py-3 px-2 mx-12 text-sm bg-red-100 text-red-700">{editdata.error}</div>
        )}
        ...
        <form onSubmit={handleSubmit} className="py-4 px-12 space-y-3">
          <div className=" space-y-1">
            ...
            <input
              ...
              value={editdata.name}
              onChange={(e) =>
                setEditData({ ...editdata, success: false, error: false, name: e.target.value })
              }
          ...
          <div className=" grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <span className="text-sm">Price (VND)</span>
              <input
                type="text"
                name="price"
          ...
          <button
            type="submit"
            className="w-full h-10 text-sm bg-black text-white rounded-sm border border-black"
          >
            Edit
          </button>
        </form>
