...
const productController = {
	...
	editProduct: async (req, res) => {
		try {
			...
			const { id, name, description, category, price, quantity, status, offer, images, brand, shipping } = req.body;
			...
			const editProduct = await Products.findByIdAndUpdate(id, editData);
